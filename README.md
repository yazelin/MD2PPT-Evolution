...
![Version](https://img.shields.io/badge/version-0.12.4-orange.svg)
...
### 🎨 專業排版系統
- **視覺對比感知系統 (v0.12.4)**: 自動檢測投影片背景亮度，即時切換文字與標題顏色，確保在任何主題或自定義背景下都具備極高可讀性。
